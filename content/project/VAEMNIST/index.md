...
$$
\mathbb{E}_{q(\mathbf z |\mathbf x, \mathbf \theta)}\bigg[\log p(\mathbf x |\mathbf \phi)\bigg] = \mathbb{E}_{q(\mathbf z |\mathbf x, \mathbf \theta)}\bigg[\log\bigg( {p(\mathbf x,\mathbf z |\mathbf \phi) }/{p(\mathbf z|\mathbf \phi,\mathbf x)}\bigg) \bigg] \\
$$
