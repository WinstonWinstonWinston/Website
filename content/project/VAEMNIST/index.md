...
$$
\mathbb{E}_{q(\mathbf z |\mathbf x, \mathbf \theta)}[\log p(\mathbf x |\mathbf \phi)] = \mathbb{E}_{q(\mathbf z |\mathbf x, \mathbf \theta)}[\log( \frac{p(\mathbf x,\mathbf z |\mathbf \phi) }{p(\mathbf z|\mathbf \phi,\mathbf x)}) ] \\
$$
